...
public:
  ...
  // * If word is empty, it should not be added to
  // the hash table, and incrWordCount should return 0.
  ...
  // returned.
  // * If the word does not exist or it is an empty string "", 
  ...
  // If the entire word is invalid, you should return an empty string ""
